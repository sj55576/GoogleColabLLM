...
このドキュメントは、`GoogleColabLLM` を構成する3つの「面」
(Colab T4ランタイム / ローカルCLI / プロキシ経由の他アプリ) が
どう繋がっているか、リクエストがどう流れるか、設定はどの順序で
解決されるかをまとめたものです。全体像は [README.ja.md](../README.ja.md) の
[3. アーキテクチャ図](../README.ja.md#3-アーキテクチャ図)・
[9. 他のアプリ向けOpenAI互換プロキシ (ゲートウェイ)](../README.ja.md#9-他のアプリ向けopenai互換プロキシ-ゲートウェイ)
も参照してください。
